  ...
  if(NumPart)
    {
      ...
      partZ = (float *) malloc( sizeof(float) * NumPart);
      partVX = (float *) malloc( sizeof(float) * NumPart);
      partVY = (float *) malloc( sizeof(float) * NumPart);
      partVZ = (float *) malloc( sizeof(float) * NumPart);
      partID = (unsigned long long *) malloc(sizeof(unsigned long long) * NumPart);
      bytes = sizeof(float) * NumPart;
      if(!(partX && partY && partZ && partVX && partVY && partVZ))
	{
